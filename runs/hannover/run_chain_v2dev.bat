...
"%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -ExecutionPolicy Bypass -File "C:\Users\Hendrik Bimmermann\hagrid-tools\chain_stepB.ps1" -StepALog "C:\Users\Hendrik Bimmermann\Documents\GitHub\HAGRID\hagrid\hagrid-output\logs\stepA_v2dev.log" -DonePattern "STEPA_V2DEV_DONE" -StepBBat "run_stepB_v2dev_batch.bat" -StepBLog "hagrid-output\logs\stepB_v2dev_batch.log" -WorkDir "C:\Users\Hendrik Bimmermann\Documents\GitHub\HAGRID\hagrid" -StartDetached "C:\Users\Hendrik Bimmermann\hagrid-tools\start_detached.ps1" -OwnLog "C:\Users\Hendrik Bimmermann\hagrid-tools\chain_v2dev.log"
