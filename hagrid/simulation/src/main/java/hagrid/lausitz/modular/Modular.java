...
public final class Modular {
     ...
     *  source of truth ({@link hagrid.lausitz.DeliveryDay}) instead of restating the numbers. */
    public static final double DELIVERY_DAY_START_S = hagrid.lausitz.DeliveryDay.START_S;
    public static final double DELIVERY_DAY_END_S = hagrid.lausitz.DeliveryDay.END_S;
