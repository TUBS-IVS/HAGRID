 ...
 * <h2>Key Classes:</h2>
 * <ul>
 *   <li>{@link hagrid.hannover.pipeline.ScenarioConfig} - User-friendly scenario configuration with fluent builder API</li>
 *   <li>{@link hagrid.hannover.pipeline.ScenarioRunner} - Orchestrates execution of pipeline scenarios</li>
 *   <li>{@link hagrid.hannover.pipeline.PipelineExecutor} - Executes individual pipeline processing steps</li>
 *   <li>{@link hagrid.hannover.pipeline.CacheConfig} - Centralized cache configuration (replaces System.setProperty)</li>
 *   <li>{@link hagrid.hannover.pipeline.PipelineLogger} - Per-run logging management</li>
 *   <li>{@link hagrid.hannover.pipeline.ScenarioSummaryWriter} - Writes human-readable run summaries</li>
 * </ul>
 * 
 * <h2>Usage:</h2>
 * <pre>{@code
