...
public final class SharedUse {
    ...
    public static final double SUBMIT_FROM_S = hagrid.lausitz.DeliveryDay.START_S;
     ...
     * (user decision 2026-07-30, {@link hagrid.lausitz.DeliveryDay}). Replaces the earlier
     ...
     */
    public static final double WINDOW_END_S = hagrid.lausitz.DeliveryDay.END_S;
