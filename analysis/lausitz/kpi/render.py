...
def render_page(title, body_html, body_js, extra_head=""):
    ...
    # The "analysis/kpi" in the marker below is the OLD path and stays: it is written
    # into every dashboard, and repointing it would change the output bytes of boards
    # that are already published. The module itself lives in analysis/lausitz/kpi/.
